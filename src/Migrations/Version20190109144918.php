 ...
 */
final class Version20190109144918 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9474526CA77FBEAF ON comment (blog_post_id)');
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, name, username, password, email, roles, password_change_date FROM user');
        ...
        $this->addSql('INSERT INTO user (id, name, username, password, email, roles, password_change_date) SELECT id, name, username, password, email, roles, password_change_date FROM __temp__user');
