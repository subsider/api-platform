 ...
 */
final class Version20190109081939 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__blog_post AS SELECT id, title, slug, published, content FROM blog_post');
        $this->addSql('DROP TABLE blog_post');
        $this->addSql('CREATE TABLE blog_post (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) DEFAULT NULL, published DATETIME NOT NULL, content CLOB NOT NULL, author VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO blog_post (id, title, slug, published, content) SELECT id, title, slug, published, content FROM __temp__blog_post');
        $this->addSql('DROP TABLE __temp__blog_post');
    }
}
